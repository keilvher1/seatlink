...
export const mockLibraries: LibraryWithDistance[] = [
  ...
  {
    id: "lib-003", name: "마포중앙도서관", address: "서울시 마포구 성아로 137",
  ...
  // ===== 대전광역시 =====
  {
    id: "lib-060", name: "대전한밭도서관", address: "대전시 서구 한밭대로 300",
...
export const mockReviews: Review[] = [
  ...
  },
  {
    ...
    mood: "😰 복잡해요",
    content: "2\uCE35 \uC5F4\uB78C\uC2E4 \uAC70\uC758 \uB9CC\uC11D\uC774\uC5D0\uC694. \uC790\uB9AC \uC7A1\uC73C\uB824\uBA74 \uC77C\uCC0D \uC624\uC154\uC57C \uD569\uB2C8\uB2E4. 1\uCE35\uC740 \uADF8\uB098\uB9C8 \uAD1C\uCC2E\uC558\uC5B4\uC694.",
  ...
  },
  {
    ...
    libraryId: "lib-060", libraryName: "\uB300\uC804\uD55C\uBC2D\uB3C4\uC11C\uAD00", roomName: "\uB178\uD2B8\uBD81\uC874",
    mood: "😊 좋아요",
    content: "\uB178\uD2B8\uBD81\uC874 \uC790\uB9AA \uB113\uB113\uD558\uACE0 \uCF58\uC13C\uD2B8 \uCDA9\uBD84\uD569\uB2C8\uB2E4. \uC640\uC774\uD30C\uC774\uB3C4 \uBE60\uB985\uB2C8\uB2E4. \uB2E8 \uC74C\uC2DD \uBC18\uC785\uC740 \uC548\uB3FC\uC694.",
...
export const mockStudyGroups: StudyGroup[] = [
  ...
  },
  {
    ...
    description: "수능 수학 기초 풀이 스터디입니다. 커리큘럼 함께 도전해요.",
    tags: ["수능", "수학", "기초"],
  },
  {
