    ...
    <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-4 h-14 flex items-center gap-4">
        ...
        <a href="/" className="flex items-center gap-2 shrink-0">
          ...
          <span className="font-bold text-lg text-slate-900">좌석이음</span>
        </a>
        ...
        <div className="flex-1 max-w-md hidden md:block">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 text-sm bg-slate-100 rounded-full border-0 focus:ring-2 focus:ring-blue-500 focus:bg-white transition"
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 ml-auto">
          <button className="p-2 rounded-full hover:bg-slate-100 text-slate-600 transition" title="접근성 모드">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z" />
            </svg>
          </button>
          <button className="hidden md:block px-4 py-1.5 text-sm font-medium text-white bg-blue-600 rounded-full hover:bg-blue-700 transition">
            로그인
          </button>
        </div>
      </div>
...
function BottomNav() {
  const tabs = [
    { href: "/", icon: "M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7", label: "지도" },
